        ...
        <div className='w-full h-full flex justify-center items-center lg:py-20 md:py-15 sm:py-10 py-5 px-8'>
            <div className='w-full h-full flex md:flex-row justify-between flex-col gap-4 items-center'>
                <div className='content w-[50%] h-full flex flex-col gap-4'>
                    ...
                    <p className=' text-lg leading-8 px-4 2xl:max-w-xl lg:w-xl w-md'>At [Your Coffee Brand Name], we’re passionate about every bean, every brew, and every smile it brings. <br /> We source the finest beans from sustainable farms around the world, roast them with care, and serve them with love. <br />
Whether you’re enjoying a cup in our cozy café or brewing at home, our mission is to deliver unforgettable flavors and a moment of joy in every sip.</p>
            ...
            <div className='lg:w-[50%] w-[35%] flex justify-center items-center h-full'>
                <div className='w-full h-full flex justify-center items-center relative'>

                    <div className='w-auto h-auto flex justify-center items-center absolute -left-12 '>
                    ...
                    <div className='w-auto h-auto flex justify-center items-center absolute -right-12 bottom-6 '>
